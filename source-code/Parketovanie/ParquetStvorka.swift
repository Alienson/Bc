...
class ParquetStvorka: Parquet {
    
    init(parent: SKSpriteNode, position: CGPoint){
        super.init(imageNamed: "5-stvorka", position: position)
        ...
        self.arrayOfCells.append(Cell(position: CGPoint(x: -height/2, y: -height/2), parent: parent))
        self.arrayOfCells.append(Cell(position: CGPoint(x: -height/2, y: height/2), parent: parent))
        self.arrayOfCells.append(Cell(position: CGPoint(x: height/2, y: -height/2), parent: parent))
        self.arrayOfCells.append(Cell(position: CGPoint(x: height/2, y: height/2), parent: parent))
